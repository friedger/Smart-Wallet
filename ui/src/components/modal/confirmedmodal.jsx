        ...
        <BaseModal baseModalsOpen={show} baseModalOnClose={close}>
            ...
            <ModalBody className='p-5 gap-4'>
                <Alert
                    ...
                    description={`The transaction has been successfully broadcasted with the following transaction ID: ${`${tx.slice(0, 5)}...${tx.length - 5, tx.length}`}. For more details regarding the transaction. 🚀🔗`}
                    title="Note:"
                    variant="faded"
                />
