...
smartWalletEndpoint: {
  "functions": {
    stxTransfer: {"name":"stx-transfer","access":"public","args":[{"name":"details","type":{"tuple":[{"name":"amount","type":"uint128"},{"name":"to","type":"principal"}]}}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[details: TypedAbiArg<{
  "amount": number | bigint;
  "to": string;
